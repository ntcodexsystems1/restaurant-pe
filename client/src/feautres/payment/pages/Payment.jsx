...
const {paymentDetails, setPaymentDetails} = useContext(CartContext)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = axios.post("http://localhost:3000/api/users", paymentDetails)
...
setPaymentDetails({
  ...
  return (
    ...
    <section className='border flex justify-center items-center  bg-white-400 md:h-screen h-auto w-full bg-Primary lg:px-28 md:py-5 md:px-5 px-4 py-4'>
      ...
      <div className='flex flex-col  container mx-auto h-auto gap-2 '>
        ...
        <form onSubmit={handleSubmit} className='border w-full flex flex-col sm:flex-row pb-16 sm:pb-2 bg-Secondary h-full sm:p-4 p-2 rounded-xl gap-4'>
          ...
          <div className='border sm:w-[60%] w-full rounded-xl md:p-4 sm:p-8 p-4 gap-6 flex flex-col '>
            ...
            <div className='flex gap-4'>
              <input type="text" placeholder='Name' className='h-12 w-[70%] sm:w-[80%] rounded px-4' name="orderName" onChange={handleChange} value={paymentDetails.orderName} />

              <input type="number" placeholder='Table no' className='h-12 w-[30%] rounded px-4' name="tableNo" value={paymentDetails.tableNo} onChange={handleChange} />
            </div>
          ...
          <div className='border rounded-xl sm:w-[40%] w-full md:p-4 sm:p-4 p-2 sm:flex hidden flex-col gap-6'>
            ...
            <div className='rounded-md w-auto'>
              <button type='submit' className="bg-Primary font-medium w-full rounded-md capitalize flex justify-center items-center p-2 h-12">
